...
def insert_data():
    ...
    with open("core/categories.json", "r", encoding="utf-8") as file:
    ...
    with open("core/actions.json", "r", encoding="utf-8") as file:
    ...
    with open("core/product.json", "r", encoding="utf-8") as file:
    ...
    with open("core/gfields.json", "r", encoding="utf-8") as file:
    ...
    with open("core/entity.json", "r", encoding="utf-8") as file:
